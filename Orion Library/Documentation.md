...
--[[
State = <bool> - Will activate or deactivate the Stream Mode.
(hides DisplayName and Profile Headshot Image)
]]
```
...
--[[
ThemeName = <string> - The Theme will change to.
Themes:
- Default;
- Red;
- Green;
...
--[[
Transparency = <number> - The Transparency value
...
OrionLib:GetTheme()
```
You can print it by using 'print()', like:
```lua
...
--[[
Asset = <string> - The asset will be changed.
Value = <color3> - The new color it will be.
...
--[[
Asset = <string> - View Assets in 'Customizing Theme' Section.
]]
```
If you want to print it, you can just placing it inside a 'print()', with no problems:
```lua
print(tostring(OrionLib:GetCustomThemeValue(Asset))) -- Will return the Color3 code in RGB from the selected Asset
```
