--[[
src: https://github.com/IcantAffordSynapse/vaehzlib/blob/main/src.lua
owner: https://github.com/IcantAffordSynapse

Vaehz Library / esore Library

links:
YouTube: https://youtube.com/@vaehz
More from Vaehz (official website): wearentdevs.net
]]
...
function Library:CreateWindow(cfg)
	...
	function Window:CreateTab(tcfg)
		...
		function Tab:CreateLabel(text)
			...
			return { Set = function(_, t) lbl.Text = t end, isLabel = true, Instance = row }
		end
